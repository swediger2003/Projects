...
/**
 * command class for the sharpen operation.
 */
public class Sharpen extends AMatrixFunction {
  ...
  public Sharpen(String imageName, String imageDest) {
    super(imageName, imageDest);
  }

  /**
   * Applies the sharpen Kernel matrix to each one of the pixels in the 2D Pixel array, and
   * saves the changes of each pixel to the imageCopy array. The calculations of the sharpen are
   * found by finding the dot product between the sharpen matrix and the surrounding pixels.
   *
