 ...
 * green pixel value as all of the color values.
 */
public class GreenGreyscale extends AFunction implements ImageFunction {


  /**
   * Constructs a GreenGreyscale command class object.
   *
   ...
   */
  public GreenGreyscale(String imageName, String imageDest) {
    super(imageName, imageDest);
  }


  /**
   * Command which turns each pixel in an images red and blue values to its green value to create
   * a grayscale image.
   *
   ...
   * @return          a copy of the pixel from the imageCopy, with the GreenGreyscale command
   *                  implemented on it.
   */
  @Override
  public Pixel[][] doSpecificOperation(Pixel[][] image, Pixel[][] imageCopy,
    ...
    imageCopy[row][col] = new Pixel(g, g, g);
    return imageCopy;
  }
}
